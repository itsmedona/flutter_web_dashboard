...
import 'package:web_application/controller/theme_controller.dart';
...
import 'package:web_application/view/widgets/master_layout/master_layout_config.dart';
          ...
          child: AppBar(
            ...
            title: mediaQueryData.size.width < kScreenWidthLg
                ...
                : ResponsiveAppBarTitle(
                    onAppBarTitlePressed: () => Get.toNamed(Routes.DASHBOARD),
                  ),
            actions: [
